...
import { TestListDeletedComponent } from './test-list-deleted.component';  // The component being tested
...
describe('TestListDeletedComponent', () => {
  let component: TestListDeletedComponent; // Initialize the component being tested
  let fixture: ComponentFixture<TestListDeletedComponent>; // Initialize a test fixture for the component
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TestListDeletedComponent], // Declare the component to be tested
      imports: [
    ...
    fixture = TestBed.createComponent(TestListDeletedComponent); // Create a fixture for the component
  ...
  // Step 1: Test the undeletion of a test
  it('should unDelete test when unDeleteTest called', async () => {
    ...
    // Step 2: Call the unDeleteTest function and verify the test is unDeleted
